  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{url('city')}}"><i class="fa fa-list"></i> <span>Cities</span></a></li>
        <li><a href="{{url('article')}}"><i class="fa fa-list"></i> <span>Articles</span></a></li>
        <li><a href="{{url('category')}}"><i class="fa fa-list"></i> <span>Categories</span></a></li>
        <li><a href="{{url('contactus')}}"><i class="fa fa-list"></i> <span>Contact Us</span></a></li>
        <li><a href="{{url('report')}}"><i class="fa fa-list"></i> <span>Reports</span></a></li>
        <li><a href="{{url('client')}}"><i class="fa fa-list"></i> <span>Clients</span></a></li>
        <li><a href="{{url('donationOrder')}}"><i class="fa fa-list"></i> <span>Donation Orders</span></a></li>
        <li><a href="{{url('settings')}}"><i class="fa fa-book"></i> <span>Settings</span></a></li>
     </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
